...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, GSConv, C2fGhost, GSConv_2, GSConv_3, CBAM, ECA}:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='E:\\insulator_gross\\yolov5-7.0\\yolov5-7.0\\models\\yolov5_efficientformerv2.yaml', help='model.yaml')
